...
export default function FotografiaPage() {
  ...
  const sections = [
    { id: "personas", title: "PERSONAS", subtitle: "Identidades capturadas en el margen de la cultura urbana.", count: 11, folder: "personas", icon: Users, accentColor: "text-accent-red" },
